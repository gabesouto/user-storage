...
export default function LoginForm() {
  ...
  return (
    <div className="flex-col flex bg-white shadow-xl py-6 px-4 rounded-lg font-lato w-11/12 max-w-md">
      <form
        onSubmit={function handleLoginSubmit(e) {
          e.preventDefault()
          const payload = {
            payload: {
              email,
      ...
      >
        ...
        <section className="bg-white text-slate-950 flex-row items-center justify-between p-5">
          ...
          <br />
          <label
            className="block text-stone-800 text-sm font-bold mb-2 mt-1"
